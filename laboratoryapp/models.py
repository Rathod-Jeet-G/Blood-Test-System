...
class LaboratoryRegister(models.Model):
    ...
    Laboratoryfname = models.CharField(max_length=20, verbose_name='Laboratory Name')
    Laboratorymname = models.CharField(max_length=20, verbose_name='First Name')
    Laboratorylname = models.CharField(max_length=20, verbose_name='Last Name')
    Laboratoryaddress = models.TextField(max_length=255, verbose_name='Address')
    Laboratorycity = models.CharField(max_length=20, verbose_name='City')
    Laboratoryarea = models.CharField(max_length=20, verbose_name='Area')
    Laboratorypincode = models.IntegerField(verbose_name='Pincode')
    Laboratorycontactno = models.IntegerField(verbose_name='Contact No')
